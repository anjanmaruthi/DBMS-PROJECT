 ...
 * @author LOOMY
 */
public class MOBILE_RECIPT extends javax.swing.JFrame {

    String s="";
    
    public MOBILE_RECIPT() 
    {
        initComponents();
    ...
    public MOBILE_RECIPT(ArrayList<String> s)
    {
        initComponents();
        showData(s);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MOBILE_RECIPT");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(51, 11, 330, 50));

        jLabel2.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        jLabel2.setText("MOBILE_ID");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 140, 150, 40));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 140, 210, 240));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MOBILE_RECIPT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MOBILE_RECIPT().setVisible(true);
            }
        });
    }
